                ...
                <div className='applicantData'>
                {
                    applicants.map((applicant, idx) => (
                            ...
                            <div key={idx}>
                                ...
                                <p> 
                                    <FontAwesomeIcon icon={faCheck} size="sm" style={{color: "#2ead43", margin:"0px 5px"}} />
                                    <FontAwesomeIcon icon={faEye} size="sm" style={{color: "#66a5e2", margin:"0px 5px"}}/>
                                    <FontAwesomeIcon icon={faX} size="sm" style={{color: "#ff0808", margin:"0px 5px"}}/>
                                    <FontAwesomeIcon icon={faComment} size="sm" style={{color: "#71abe4", margin:"0px 5px"}}/>
                                </p>
                            </div> 
