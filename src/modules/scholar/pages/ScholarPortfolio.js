...
import "modules/scholar/style.scss";
...
function ScholarPortfolio() {
    ...
    const fetchPortfolio = async () => {
        API.request('scholar_portfolio/retrieveMultipleByParameter', { col: 'scholar_id', value: details.user_id }, 
        response => {
